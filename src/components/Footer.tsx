      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mb-12">
          <div className="flex items-center mb-6">
            <span className="text-3xl font-bold text-white">Bozz Tips</span>
          </div>
          <p className="text-gray-300">
            Football betting is fun, period. Whether it's a rousing victory or a crushing defeat but without
            some level of guidance and knowledge, football betting is a high risk venture. Everyday, football
            fans around the world are actively seeking for websites and platforms that offer accurate
            predictions and profits over the long term.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/vvip" className="text-gray-300 hover:text-red-500">
                  VVIP
                </Link>
              </li>
              <li>
                <Link href="/login" className="text-gray-300 hover:text-red-500">
                  LOGIN
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li className="text-red-500"><Link href="/predictions/htft" className="text-gray-300 hover:text-red-500 ml-2">HT/FT</Link></li>
