			...
			<div className="container mx-auto px-4 py-12">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
					...
					<div className="bg-white p-6 rounded-lg shadow-md">
						...
						<p className="text-3xl font-bold text-red-600">{allPSlips.length}</p>
						<p className="text-gray-600 mt-2">In The Last 30 days</p>
							...
							{showPurchasedDropdown && (
								<div className="absolute left-0 mt-2 w-full bg-white border border-gray-200 rounded shadow-lg z-10 max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-blue-50">
									{allPSlips.length === 0 ? (
										...
										<ul>
											{allPSlips.map((slip) => (
												<li key={slip.slip_id} className="px-4 py-3 border-b last:border-b-0">
													<div
													...
													>
														...
														<div className="text-red-600 font-bold text-lg md:text-base mt-2 md:mt-0">{slip.price}</div>
													</div>
