...
const useUpdateCheck = () => {
    ...
    useEffect(() => {
        ...
        try {
            const [updates,userPurchase] = await Promise.all([axios.get("https://wonit-backend.onrender.com/check-today/",            ),
            axios.get("https://wonit-backend.onrender.com/check-user-purchases/",{
